...
- Tạo layout động từ file template có sẵn:
+ Copy toàn bộ nội dung file .html có sẵn và paste vào file này
 (đang demo = template AdminLTE)
 + Copy toàn bộ các file css, js, image của template vào thư mục assets của MVC
 + Kiểm tra lại đường dẫn tới file css, js, image xem đã đúng chưa
 + echo các thuộc tính động của controller cha
-->
<!DOCTYPE html>
<html>
<head>
...
<script>
 // Code tích hợp CKEditor và CKFinder vào textarea qua name của thẻ textarea
 // THam khảo 2 slide tương ứng để cài đặt
